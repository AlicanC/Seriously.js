...
module.exports = new Plugin('tvglitch', function () {
	var lastHeight,
		lastTime,
		particleBuffer,
		particleShader,
	...
	return {
		initialize: function (parent) {
			...
			particleShader = new utillll.ShaderProgram(gl, particleVertex, particleFragment);

			particleFrameBuffer = new utillll.FrameBuffer(gl, 1, Math.max(1, this.height / 2));
			parent();
		},
		commonShader: true,
		shader: function (inputs, shaderSource) {
			shaderSource.fragment = [
				...
				utillll.shader.noiseHelpers +
				utillll.shader.snoise2d +
